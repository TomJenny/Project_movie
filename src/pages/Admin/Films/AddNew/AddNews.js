...
import { postAPINewsFilmAction } from "../../../../redux/actions/FilmAction";
...
export default function Edit(props) {
  ...
  const onFinish = (values) => {
    ...
    filmObj.ngayKhoiChieu = moment(values.ngayKhoiChieu).format("DD/MM/YYYY");
    ...
    dispatch(postAPINewsFilmAction(formData));
  };
  ...
  return (
    <>
      <Form
        ...
        layout="horizontal"
      >
        <HeadingH1Styled>ADD NEW FILM </HeadingH1Styled>
            ...
            <Col span={8}>
              <Row justify="center">
                <Image
                  ...
                  src={
                    imgSrc === ""
                      ? `${PUBLIC_URL + "/img/Error/errorImage.png"}`
                      : imgSrc
                  }
                />
              </Row>
