...
var LoadingImg = _styledComponents["default"].img(_templateObject());

exports.LoadingImg = LoadingImg;

var LoadingContainer = _styledComponents["default"].div(_templateObject2(), function (_ref) {
  var theme = _ref.theme;
  return theme.colors.black1;
}, _setting.PUBLIC_URL);

exports.LoadingContainer = LoadingContainer;
var rotateLoader = (0, _styledComponents.keyframes)(_templateObject3());

var Loader = _styledComponents["default"].div(_templateObject4(), rotateLoader);
